...
<body themebg-pattern="theme1">
                        ...
                        <div class="auth-box card">
                            <div class="card-block">
                                ...
                                <div class="row m-t-30">
                                    <div class="col-md-12">
                                        <button type="submit" class="btn btn-primary btn-md btn-block waves-effect waves-light text-center m-b-20" name="login_now">Sign in</button>
                                    </div>
                                </div>
                                <hr />
    ...
    if (isset($_POST['login_now'])) {
        $username = $_POST['email']; // Assuming email field is used for username
        $password = $_POST['password'];

        // Hash the password for comparison (you should use a stronger hashing method in production)
        $hashed_password = md5($password); // Example hashing, not recommended for production

        // Check if the user is an administrator
        $admin_query = "SELECT admin_id FROM Administrator WHERE username='$username' AND password='$hashed_password'";
